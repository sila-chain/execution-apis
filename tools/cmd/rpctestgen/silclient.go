...
type silclientHandler struct {
	rpc       *rpc.Client
	logFile   *os.File
	transport *loggingRoundTrip
}

func newSilclientHandler(addr string) (*silclientHandler, error) {
	rt := &loggingRoundTrip{
...
func (l *silclientHandler) RotateLog(filename string) error {
	if l.logFile != nil {
...
func (l *silclientHandler) WriteComment(text string) error {
